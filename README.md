...
With a fixed number of players,  we can start the app right into a new game,  with maybe some intro information.  
effectively display the board
prompt for player move
display updated board (victory if occured)
prompt next player for move
-repeat
